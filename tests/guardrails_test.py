...
check("path-traversal", "path-traversal" in input_scan("cat ../client-b/secret.txt"))
check("cross-scope-path", "cross-scope-path" in input_scan("open /workspace/scopes/client-b/notes.md"))
