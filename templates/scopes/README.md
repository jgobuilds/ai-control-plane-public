...
| `consulting.json` | enterprise › consulting › siloed tenants (+ ethical walls) + internal | a firm with competing tenants that must never share a runner |
...
example nodes (`tenant-a`, `data-team`, `you`, …) to your own; add `owner`,
