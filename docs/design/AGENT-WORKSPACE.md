...
inside it. Read both before mounting real tenant data.
...
├── ai-control-plane/                  # ← launch here for the control plane work
├── verdantground/
...
**This is the same idea the control plane already enforces at the container edge.**
...
| Concept | Local agent | the control plane runner |
|---|---|---|
...
## 10. How the control plane applies this
