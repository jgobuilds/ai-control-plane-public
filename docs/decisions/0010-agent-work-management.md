...
Resolves **G10** in `GAP-CLOSURE-PLAN.md` (internal) and the
**E4** market row.
...
| **H. Bring-your-own ticket system** (GitHub Issues / Linear / Jira) | Free tier → per-seat metered. Non-dollar: **egress of tenant-linked work metadata to a third party** | **Reject for tenant work** — contradicts the no-external-processor positioning that is the whole niche. Viable for the engine's own dogfooding only |
