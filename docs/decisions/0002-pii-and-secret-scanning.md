...
| ggshield | free tier; **metered above it** (SaaS) | secrets | MIT *tenant* | active | **Reject — cloud-gated.** Detector is GitGuardian's proprietary backend; every scan uploads file contents |
