...
```bash
python scripts/n8n_bootstrap.py --activate aicp-drive-sync
python scripts/n8n_bootstrap.py --activate aicp-deliverables
...
`RESEARCH-AND-MARKETING-LANES.md` (internal)
