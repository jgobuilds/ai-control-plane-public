#!/usr/bin/env python3
"""Provable client offboarding — right-to-deletion with an evidence trail.
...
under audit/deletions/. Pure stdlib. Windows-friendly (os.path only).
    ...
    python scripts/offboard_scope.py client-a --confirm --operator jon
...
def main(argv=None):
    ap = argparse.ArgumentParser(description="Provable client offboarding (right-to-deletion).")
